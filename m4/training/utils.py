...
nougat_transform = alb_wrapper(
    alb.Compose(
        [
            ...
            alb.ImageCompression(compression_type='jpeg',quality_range=(95,100), p=0.07),
            alb.GaussNoise(std_range=(0.2,0.44),mean_range=(0,0),per_channel=True,noise_scale_factor=0.05, p=0.08),
            alb.GaussianBlur(blur_limit=0,sigma_limit=(3, 3), p=0.03),
        ]
    )
)
